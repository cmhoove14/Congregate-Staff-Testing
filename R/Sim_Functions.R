...
sim_work_transmission <- function(Lambda, R_work, R, delay, test_thresh, workers, sim_t, dt, verbose = FALSE){
...
# Simulate transmission given parameters, time characteristics, and workers
sim_work_transmission2 <- function(Lambda, R_work, R, delay, test_thresh, test_sens, test_spec, workers, sim_t, dt, verbose = FALSE){
  ...
  for(t in 2:sim_t){
    ...
    workers <- test_workers(test_indices = tested, workers = workers, 
                            timestep = t, test_thresh = 0, test_sens = 1, test_spec = 1, delay = 0)
...
# Simulate transmission given parameters, time characteristics, and workers
sim_work_transmission_selfiso <- function(Lambda, alpha, R, delay, test_thresh, workers, sim_t, dt, p_symp, verbose = FALSE){
