...
## Self isolation  
```{r selfiso_plot, include=T, fig.height=4, fig.width=4, fig.cap="Expected transmissions across probability of self isolating if infection is symptomatic. "}
iso_sims_sum %>% 
...
iso_sims_sum %>% 
  ...
  ggplot(aes(x = p_selfiso, y = per_avoid_sys)) +
    geom_point() +
    theme_classic() +
    labs(x = "Proportion symptomatic who self isolate",
         y = "Proportion transmissions avoided by systematic strategy")
