...
## Self isolation  
```{r selfiso_plot, include=T, fig.height=6, fig.width=4, fig.cap="Expected transmissions across probability of self isolating if infection is symptomatic. The advantages of systematic testing are diminished when more people self isolate"}
iso_sims_sum %>% 
